...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.0, 108.0, 311.0, 127.0 ],
					"text" : "The external will continuously output pitch estimations, even when there is no discernable sound input.\n\nThis behaviour is not usually desirable so we provide 2 internal thresholding options to stop the pitch output (output midi -1500)\n\n@conf <value> - threshold by confidence \n@amp <value> - threshold by amplitude"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 108.0, 313.0, 33.0 ],
